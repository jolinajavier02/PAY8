...
export function LoginScreen() {
  ...
  const initializeBasicAccount = usePay8((s) => s.initializeBasicAccount);
  ...
  const handleConfirmPin = () => {
    ...
    initializeBasicAccount(fullPhone, country, pin);
    resetToHome();
    showToast({ title: "Welcome to PAY8", description: "Basic account created. Verify later from your profile.", variant: "success" });
  };
