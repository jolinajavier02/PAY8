    ...
    <div className="flex min-h-screen flex-col">
      ...
      <header className="pay8-gradient-navy px-5 pt-12 pb-5 text-white">
        <div className="flex items-center gap-2">
          <img src="/logo-white.jpeg" alt="PAY8 logo" className="pay8-logo h-8 w-8" />
    ...
    <div className="space-y-5">
      <div className="flex flex-col items-center rounded-2xl border border-border bg-card p-6">
        ...
        <div className="relative mt-5">
          ...
          <Pay8QR value={payload} size={220} className="relative" includeLogo={true} logoUrl="/logo-white.jpeg" />
        </div>
